...
# It's possible for list to hold values of mixed data types Although it isn't recommended.
mixed = ["John", 25, False, 3.14, ["Chris"]]

#  It's okay to define an empty list. Items can always be added later.
empty_list = []
